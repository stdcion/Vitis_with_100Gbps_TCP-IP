...
#pragma HLS dataflow
          ...
          //
          // ПОЧЕМУ ФАЗА 3 РАБОТАЛА С ТЕМИ ЖЕ ФУНКЦИЯМИ: там ВСЕ 12 стадий
          // висели вечно. Ни одна не ждала перезапуска, каждая обрабатывала
          // свой поток внутри одного вызова. ap_done=0 там тоже был, и это
          // было нормально.
          //
          // Ломает именно СМЕСЬ: короткие стадии рядом с висящими.
          //
